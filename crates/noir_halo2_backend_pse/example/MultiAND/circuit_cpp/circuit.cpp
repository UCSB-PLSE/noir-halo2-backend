...
uint get_main_input_signal_no() {return 4096;}

uint get_total_signal_no() {return 65533;}

uint get_number_of_components() {return 8190;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 8192;}
...
MultiAND_1_run(mySubcomponents[cmp_index_ref],ctx);
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[3]); // line circom 32
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 2;
{
...
{
std::string new_cmp_name = "and2";
AND_0_create(mySignalStart+65,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint aux_create = 1;
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_5_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (32 + Fr_toInt(&lvar[3]))) + 1)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_5_run(mySubcomponents[cmp_index_ref],ctx);
...
{
std::string new_cmp_name = "and2";
AND_0_create(mySignalStart+129,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint aux_create = 1;
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[7]); // line circom 32
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 2;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (64 + Fr_toInt(&lvar[3]))) + 1)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_6_run(mySubcomponents[cmp_index_ref],ctx);
...
{
std::string new_cmp_name = "and2";
AND_0_create(mySignalStart+257,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint aux_create = 1;
...
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_7_run(mySubcomponents[cmp_index_ref],ctx);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (128 + Fr_toInt(&lvar[3]))) + 1)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_7_run(mySubcomponents[cmp_index_ref],ctx);
...
{
std::string new_cmp_name = "and2";
AND_0_create(mySignalStart+513,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint aux_create = 1;
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (256 + Fr_toInt(&lvar[3]))) + 1)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_8_run(mySubcomponents[cmp_index_ref],ctx);
...
{
std::string new_cmp_name = "and2";
AND_0_create(mySignalStart+1025,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint aux_create = 1;
...
Fr_lt(&expaux[0],&lvar[3],&circuitConstants[10]); // line circom 32
while(Fr_isTrue(&expaux[0])){
{
uint cmp_index_ref = 2;
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (512 + Fr_toInt(&lvar[3]))) + 1)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_9_run(mySubcomponents[cmp_index_ref],ctx);
...
{
std::string new_cmp_name = "and2";
AND_0_create(mySignalStart+2049,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint aux_create = 1;
int aux_cmp_num = 1+ctx_index+1;
uint csoffset = mySignalStart+2052;
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
std::string new_cmp_name = "ands"+ctx->generate_position_array(aux_dimensions, 1, i);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (1024 + Fr_toInt(&lvar[3]))) + 1)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_10_run(mySubcomponents[cmp_index_ref],ctx);
...
{
std::string new_cmp_name = "and2";
AND_0_create(mySignalStart+4097,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
uint aux_create = 1;
int aux_cmp_num = 1+ctx_index+1;
uint csoffset = mySignalStart+4100;
uint aux_dimensions[1] = {2};
for (uint i = 0; i < 2; i++) {
std::string new_cmp_name = "ands"+ctx->generate_position_array(aux_dimensions, 1, i);
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * (2048 + Fr_toInt(&lvar[3]))) + 1)]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
MultiAND_11_run(mySubcomponents[cmp_index_ref],ctx);
...
MultiAND_12_create(1,0,ctx,"main",0);
MultiAND_12_run(0,ctx);
}
