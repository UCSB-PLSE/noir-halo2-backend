...
uint get_size_of_witness() {return 1002;}
...
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 1000],&lvar[3]); // line circom 10
...
{
{{
Fr_eq(&expaux[0],&lvar[1],&signalValues[mySignalStart + 1000]); // line circom 16
}}
