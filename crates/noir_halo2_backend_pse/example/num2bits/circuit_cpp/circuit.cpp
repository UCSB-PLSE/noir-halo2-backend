...
uint get_total_signal_no() {return 4100;}

uint get_number_of_components() {return 2;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 4098;}
...
// load src
Fr_shr(&expaux[1],&signalValues[mySignalStart + 4096],&lvar[3]); // line circom 10
...
{
{{
Fr_eq(&expaux[0],&lvar[1],&signalValues[mySignalStart + 4096]); // line circom 16
}}
